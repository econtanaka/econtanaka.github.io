<h2 id="working-papers" style="margin: 25px 0px -15px;">Working Papers</h2>

<div class="publications">
<ol class="bibliography">
{% for link in site.data.publications.working_papers %}
<li>
<div class="pub-row">
  <div class="col-sm-12" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="links">
      ...
      {% if link.journal %}<a href="{{ link.journal }}" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Journal</a>{% endif %}
...
<h2 id="work-in-progress" style="margin: 25px 0px -15px;">Work in Progress</h2>

<div class="publications">
<ol class="bibliography">
{% for link in site.data.publications.work_in_progress %}
<li>
<div class="pub-row">
  <div class="col-sm-12" style="position: relative;padding-right: 15px;padding-left: 20px;">
